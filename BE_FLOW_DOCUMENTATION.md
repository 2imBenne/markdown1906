...
<table border="1" style="border-collapse: collapse; width: 100%; margin-bottom: 20px;">
  ...
  <tr>
    <td colspan="2" style="padding: 8px;">
      ...
      2. Tài khoản đang bị khóa (is_blocked): Hệ thống từ chối truy cập (403 Forbidden).
    </td>
  </tr>
</table>
...
<table border="1" style="border-collapse: collapse; width: 100%; margin-bottom: 20px;">
  <tr>
    <td style="width: 25%; padding: 8px;"><b>Tên use case</b></td>
    <td style="padding: 8px;"><b>Quản trị Người dùng & Phân quyền</b></td>
  </tr>
  <tr>
    <td style="padding: 8px;"><b>Tác nhân chính</b></td>
  ...
  <tr>
    <td style="padding: 8px;"><b>Hậu điều kiện</b></td>
    <td style="padding: 8px;">Tài khoản bị khóa hoặc Staff được gán quyền mới</td>
  </tr>
  <tr>
    <td colspan="2" style="padding: 8px;">
      <b>Kịch bản chính</b><br>
      ...
      3. [Phân quyền Staff] Admin chọn Staff, tick chọn các permission (VD: `appointment:manage`). Hệ thống lưu vào bảng trung gian.
    </td>
  </tr>
  <tr>
    <td colspan="2" style="padding: 8px;">
